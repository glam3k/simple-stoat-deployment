...
export const TYPES_VALID_CATEGORY = {
  ...
  "Account Trade": "Buying or selling of platform accounts",
...
export function reportCategoryTemplateResolutionResponse(
  ...
  switch (key?.[0]) {
    ...
    case "Not Enough Evidence":
      return `These report(s) have not been actioned at this time due to a lack of supporting evidence, if you have additional information to support your report, please either report individual relevant messages or send an email to ${SUPPORT_EMAIL}.`;
    case "Clarification Needed":
      return `These report(s) need clarification and no further action can be taken at this time.\nIf you have additional information to support your report, please either report individual relevant messages or send an email to ${SUPPORT_EMAIL}.`;
